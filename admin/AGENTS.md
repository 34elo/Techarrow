...
## Project: City Quest Platform

### Overview
City Quest Platform — веб-приложение для создания и прохождения городских квестов с геолокацией. Пользователи создают маршруты с чекпоинтами на карте, проходят квесты в одиночку или командами, получают очки и участвуют в рейтинге.
